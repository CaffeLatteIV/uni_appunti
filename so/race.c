...
#define MAX 100000
/*
 * volatile impedisce al so saltare il for e restituire già il risultato (i so sono molto intelligenti)
 * atomic si occupa di eliminare le race condition (circa)
 * */
